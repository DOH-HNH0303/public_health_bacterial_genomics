...
workflow recomb_aware_phylo_analysis {
  ...
  output {
    String recomb_aware_phylo_analysis_version = version_capture.phbg_version
    String recomb_aware_phylo_analysis_date = version_capture.date
    ...
    String ska_iqtree_model = ska_iqtree.iqtree_model
  }
}
